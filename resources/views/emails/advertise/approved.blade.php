...
<head>
    <meta charset="utf-8">
    <title>{!! \Illuminate\Support\Facades\Storage::get('website/email/advertise/approved/title.txt') !!} </title>
</head>
<p>Hello <b>{{ $advertisement->full_name }}</b>,</p>
<p>{!! \Illuminate\Support\Facades\Storage::get('website/email/advertise/approved/body.txt') !!}</p>
<div class="signature">
