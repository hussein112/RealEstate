...
<head>
    <meta charset="utf-8">
    <title>{!! \Illuminate\Support\Facades\Storage::get('website/email/advertise/rejected/title.txt') !!} </title>
</head>
<p>Hello <b>{{ $advertisement->full_name }}</b>,</p>
<p>{!! \Illuminate\Support\Facades\Storage::get('website/email/advertise/rejected/body.txt') !!}</p>
<div class="signature">
