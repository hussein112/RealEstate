...
<head>
    <meta charset="utf-8">
    <title>{!! \Illuminate\Support\Facades\Storage::get('website/email/valuation/approved/title.txt') !!} </title>
</head>
<p>Hello <b>{{ $valuation->full_name }}</b>,</p>
<p>{!! \Illuminate\Support\Facades\Storage::get('website/email/valuation/approved/body.txt') !!}</p>
<div class="signature">
