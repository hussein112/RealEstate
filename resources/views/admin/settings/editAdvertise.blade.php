<x-admin-layout>
    <x-slot name="main">
        <main class="container">
            <x-page-title title="advertise" subtitle="list the advertisement rules"></x-page-title>
            ...
            <form action="{{ route("edit-advertise") }}" method="post" class="new-post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <input type="text" name="quote" class="form-control my-2" placeholder="Quote" value="{!! \Illuminate\Support\Facades\Storage::get('website/advertise/quote.txt') !!}">
