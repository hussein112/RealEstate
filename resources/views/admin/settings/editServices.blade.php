<x-admin-layout>
    <x-slot name="main">
        <main class="container">
            <x-page-title title="services" subtitle="describe what your company gives the customer"></x-page-title>
            ...
            <form action="{{ route("edit-services") }}" method="post" class="new-post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <input type="text" name="quote" class="form-control my-2" placeholder="Quote" value="{!! \Illuminate\Support\Facades\Storage::get('website/services/quote.txt') !!}">
